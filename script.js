const namesByLanguage = {
    all: ["Saicharan", "Mandar", "Janaki", "Shaheen", "Nikhil.P", "Lokesh", "Sonali", "Chithra", "Kamal", "Raju", "Akshay", "Bhagya", "Haresh", "Vidya", "Jagadeesh", "Vishesh", "Shweta", "Gaurav", "Kirti", "Sanket", "Priyanka.K", "Darshita", "Ramya", "Priya, Tiwar", "Divyansha", "Haritha", "Suvarna", "Deepan", "Alekhya", "Suraiya", "Mahima", "Ankit", "Amar", "Saipriya", "Kavya", "Nidhi", "Ashwin", "Saran", "Tarun", "Sandeep", "S. VenkateshBabu", "NagaTeja", "Indravalli", "Vaishnavi", "Divya", "Suchitra", "Srilakshmi", "Krishna", "Nikhitha", "Gayathri", "Santhosh", "Ranjith", "Ritika", "Nikhil.Sabbani","Ajitha", "Samyuktha", "Triveni", "Shivkumar", "Sushma", "Prasannatha", "Tanuja", "Harini"],
    telugu: ["Shaheen", "Lokesh", "Jagadeesh", "Saipriya", "Gayathri", "Nikhitha", "Santhosh", "Nikhil.Sabbani", "Nidhi", "Saran", "Tarun", "S. VenkateshBabu", "NagaTeja", "Indravalli", "Vaishnavi", "Divya", "Suchitra", "Srilakshmi", "Krishna", "Ajitha", "Samyuktha", "Triveni", "ShivKumar","Sushma", "Prasannatha", " Tanuja"], 
    kannada: ["Shweta", "Priyanka.K", "Kavya", "Bhagya", "Ramya", "Divya", "Shivkumar", "Vidya"],
    hindi: ["Saicharan", "Mandar", "Sonali", "Chitra", "Kamal", "Raju", "Akshay", "Vishesh", "Gaurav", "Kirti", "Sanket", "Mahima", "Ankit", "Amar","Divyansha"],
    tamil: ["Janaki", "Lokesh", "Sharon", "Darshita", "Deepan", "Suraiya", "harish", "Sandeep", "Ranjith", "Jagadeesh", "Harini"]
    
}; 
const namesByCareerLevel = {
    SSE: ["Vidya", "Jagadeesh", "Vishesh", "Shweta", "Sharon", "Gaurav", "Kirti", "Sanket", "Priyanka.K", "Darshita", "Ramya", "Priya, Tiwar", "Divyansha", "Haritha", "Suvarna", "Deepan", "Alekhya"],    
    SE: ["Suraiya", "Mahima", "Ankit", "Amar", "Saipriya", "Kavya", "Gayathri", "Nikhitha", "Santhosh", "Ranjith", "Ritika", "Nikhil.Sabbani", "Nidhi", "Ashwin", "Saran", "Tarun", "Sandeep", "S. VenkateshBabu"],
    LeadsAndAbove: ["Saicharan", "Mandar", "Janaki", "Shaheen", "Nikhil.P", "Lokesh", "Sonali", "Chitra", "Kamal", "Raju", "Akshay", "Bhagya", "Haresh"],
    ASE: ["NagaTeja", "Indravalli", "Vaishnavi", "Divya", "Suchitra", "Srilakshmi", "Krishna", "Ajitha", "Samyuktha", "Triveni", "ShivKumar", "Sushma","Prasannatha", "Tanuja", "Harini"]
};
